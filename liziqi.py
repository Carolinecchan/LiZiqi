...
print(data_analysis('Liuzhou Luosifen翻译.csv','美食').to_string())
print(data_analysis('New Year snacks 翻译.csv','美食').to_string())
print('评论总数： ',comment_sum(data_analysis('Liuzhou Luosifen翻译.csv', '美食'), data_analysis('New Year snacks 翻译.csv', '美食')))
